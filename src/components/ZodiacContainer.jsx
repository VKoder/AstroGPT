  ...
  return (
    <div className="flex-col px-4 lg:px-14 flex justify-center my-10 items-start relative w-12/12 opacity-90">
      <div className="lg:h-[50vh] px-4 lg:px-10 flex flex-col justify-center  items-center my-6 lg:my-14 pt-6 lg:pt-24 py-4 rounded-2xl w-full">
        ...
        <div className="w-full flex lg:justify-center items-center pt-6 lg:text-center text-left lg:pt-8 ">
            <span className="text-purple-200 opacity-90 font-normal lg:text-lg tracking-wider text-sm lg:tracking-wide">Dive into the mystical world of astrology with our comprehensive horoscope section. Discover the secrets written in the stars and unlock insights into your personality, relationships, and future. Whether you're a seasoned astrology enthusiast or just curious about what the cosmos has in store for you, our horoscope section is your guide to understanding the celestial forces shaping your life.</span>
        </div>
      </div>
      <ZodiacCardsList />
    </div>
