  ...
  return (
    <div className="pt-14 w-12/12 ">
      ...
      <div className="lg:w-8/12 w-12/12">
        ...
        <div className="flex lg:flex-row flex-col px-3 py-2  border-purple-900 border rounded-xl bg-purple-950 bg-opacity-55">
        ...
        <div className="flex flex-col lg:flex-row lg:px-3 px-2 py-2 justify-start gap-4 lg:gap-10 border-purple-900 border rounded-xl w-[45%] lg:w-6/12 bg-purple-950 bg-opacity-55">
