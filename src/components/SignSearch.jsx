...
const SignSearch = () => {
  ...
  return (
    <div className='flex justify-center flex-col items-center lg:my-28 my-12 lg:mb-0 mb-28 w-12/12 bg-purple-950 bg-opacity-55 py-8 lg:py-14'>
...
etesde dolore magna aliquapspendisse and the gravida.
      ...
      <div className='flex lg:flex-row flex-col justify-center lg:pt-0 pt-6 w-full px-4 lg:px-28 lg:justify-evenly items-center'>
        ...
        <button className='lg:px-10 px-8 lg:mt-0 mt-2 py-2 lg:py-3 rounded-br-2xl rounded-tl-2xl text-xl bg-purple-800 text-white uppercase font-semibold lg:tracking-wide'>Find </button>
        </div>
      </div>
      </div>
    </div>
